...
self.importScripts(
    './lib/liblouis/build-no-tables-utf16.js',
    './lib/liblouis/easy-api.js'
);
    ...
    switch (type) {
        case 'translate':
            ...
            try {
                ...
                console.log('[BRAILLE WORKER] Available tables:', liblouis.getTable('en-us-g2.ctb'));
                console.log('[BRAILLE WORKER] Translation for "can":', liblouis.translateString('en-us-g2.ctb', 'can'));
                console.log('[BRAILLE WORKER] Translation for "the":', liblouis.translateString('en-us-g2.ctb', 'the'));
                
                // Try backward translation to see if contractions work
                console.log('[BRAILLE WORKER] Back translation of "c":', liblouis.backTranslateString('en-us-g2.ctb', 'c'));
                ...
                console.log('[BRAILLE WORKER] Unicode chars:', brailleText.split('').map(c => `${c} (U+${c.charCodeAt(0).toString(16).padStart(4, '0')})`).join(' '));
